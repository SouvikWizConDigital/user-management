...
This project provides a robust backend for user identity and management with ADMIN and USER roles, powered by **Spring Boot 3** and **PostgreSQL**. The API is fully documented using **OpenAPI 2.5**.
